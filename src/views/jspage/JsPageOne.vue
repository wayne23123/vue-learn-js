    ...
    <div class="leftNav">
      <div class="leftNavContainer">
        <div class="leftNavLayout">
          ...
          <div @click="locate('onejs030')" class="leftNavText">數組清空</div>
    ...
    <div class="Main">
      <div class="mainContainer">
        <div class="mainLayout">
          ...
          <br />
          <p>0.1 的二進制 可用 0.1.toString( 2 )</p>
          <br />
          <p>發現是 0. 000 11 0011 0011 0011 0011 0011 ...</p>

          <br />
          <p>number 類型 用 IEEE754 標準 64 位 存儲</p>
          <br />
          <p>小數佔位 52 位</p>
          <br />
          <p>又因為 53 位為 1 , 所以擷取往前進 1 位再保存</p>
          <br />
          <p>發生精度丟失</p>
          <br />
          <p>所以 0.1 再 2 進制後 比 0.1 大</p>
          <br />
          ...
          <p>arr.at(-1)</p>
          <br />
          <div id="onejs030" class="articleCardTitle cor36">
            [ JS ] ≫ 數組清空?
          </div>
