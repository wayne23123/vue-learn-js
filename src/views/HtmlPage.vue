  ...
  <section>
    ...
    <div class="Main">
      <div class="mainContainer">
        ...
        <h3>差別:</h3>
        <p class="pFou">
          herf 用在 link , a ; 而 src 用在 img , style , script
        </p>
        <br />
        <h3 class="pFou">
        ...
        <br />
        <h3 class="pFou">
          瀏覽器遇到 src 會暫停其他資源的下載和處理, 直到該資源加載 或
          執行完畢。
        </h3>
        <br />
        <br />
        ...
        <p>標準模式：</p>
        <p>
          瀏覽器 使用 W3C 的標準 解析渲染 網頁，瀏覽器 以 其 支持的最高標準
          呈現頁面。
        </p>
        <br />
        <p>怪異模式：</p>
        <p>
          瀏覽器 用自己的 怪異模式 解析和渲染 網頁，頁面 以 一種 較 寬鬆的
          向後兼容的 方式 顯示。
        </p>
        <br />
        <br />
        ...
        <br />
        <p>
          使用 JS 動態給 iframe 添加 src 屬性值可以避免 阻塞主頁面的onload事件
          和 和主頁面共享連接池
        </p>
        <br />
        ...
        <div class="bgcVS">
          ...
          <div class="comment">
            // height
            設置viewport高度，一般設置寬度後，高度會自動解析，可以不設置
          </div>
          <br />
          <div class="comment">
            // initial-scale
            默認縮放比例（初始縮放比例），為一個數字，可以帶小數
          </div>
          <br />
          <div class="comment">
